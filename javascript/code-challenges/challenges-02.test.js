...
// const evenOdd = (arr) => {
//   // Solution code here...
//   // map through all of the 'numbers', check if it is actually a number. if not, return 'N/A'. Else if it is then check if even or odd using mod and return the string even or odd accordingly. return the new array
//   let evenOddArray = arr.map((number) => {
//     if (!(typeof number === "number")) {
//       return "N/A";
//     }
//     if (number % 2 === 1) {
//       if (typeof number === "number") return "odd";
//     } else {
//       return "even";
//     }
//   });
...
const extractAbilities = (arr) => {
  // Solution code here...
  const abilityArr = arr.map((snorlax) => {
...
const extractStats = (arr) => {
  // Solution code here...
  const statArray = arr.map((snorlax) => ({
